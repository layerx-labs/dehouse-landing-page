...
const Title = tw.h2`text-5xl text-c4-l mb-8 mt-8 flex justify-center font-bold leading-tight`;

const SubTitle = tw.h3`text-2xl text-c4-l mb-8 flex justify-center font-bold leading-tight`;
